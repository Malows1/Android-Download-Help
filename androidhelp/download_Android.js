  ...
  return (
    <ScrollView>
      ...
      <SafeAreaView style={styles.content}>
       ...
       <Text style = {styles.textstyle}>1. On Your Android Device, tap the Play {'\n'}
       Store icon open the App
        </Text>
        <Image source={playstore} style={styles.openplay}/>
      
     <View style = {styles.step2}>
        <Text style = {styles.textstyle}>2. Search for GoPlay360 in the search{'\n'} bar  
        at the top of the screen </Text>
<Image source={search} style = {styles.search}/>
        </View>

        <View style = {styles.step3}>
        <Text style = {styles.textstyle}>3. Click the install and once  it finish {'\n'}  it show this 
       </Text>
<Image source={finish} style = {styles.open}/>
        </View>

        <View style = {styles.step4}>
        <Text style = {styles.textstyle}>4. Tap on the open button to lunch {'\n'} 
        the GoPlay360 </Text>
